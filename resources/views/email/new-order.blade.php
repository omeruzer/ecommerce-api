                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#47C68E"
                                            style="Margin:0;padding-top:35px;padding-bottom:35px;padding-left:35px;padding-right:35px;background-color:#47c68e">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank"
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#ED8E20;font-size:16px"><img
                                                                            src="https://uhquiy.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png"
                                                                            alt
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">
                                                                        You can see the order details here.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
